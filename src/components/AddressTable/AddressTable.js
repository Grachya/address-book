...
class AddressTable extends React.Component {
    constructor(props){
        ...
        this.state = {
            addressList: [
                {id:1, name: 'Галина', email: 'galina@ya.ru', phone:'89034567582'},
                {id:2, name: 'Алла', email: 'alla@ya.ru', phone:'89167658734'},
                {id:3, name: 'Юлия', email: 'yulia@ya.ru', phone:'89264567652'},
              ]
        }
    }
