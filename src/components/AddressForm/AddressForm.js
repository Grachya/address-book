        ...
        <tr>
            <td className="table__data table__data--edit">
                <Input
                    ...
                    onChangeHandler={e =>
                        props.handleChange(props.address.id, 'name', e.target.value)
                    }
                />
            </td>
            <td className="table__data table__data--edit">
                <Input
                    ...
                    onChangeHandler={e =>
                        props.handleChange(props.address.id, 'email', e.target.value)
                    }
                />
            </td>
            <td className="table__data table__data--edit">
                ...
                {props.address.isEditing ? (
                    <div>
                        <Button
                            icon="save"
                            onClickHandler={() => {
                                props.toggleAddressEdit(props.address.id);
                            }}
                        ></Button>
                        <Button
                            icon="remove"
                    ...
                    <Button icon="add" onClickHandler={() => props.addNewAddress()}></Button>
                )}
            </td>
        </tr>
    );
